...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(URL::asset('assets/css/bootstrap-responsive.min.css')); ?>" rel="stylesheet" />
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/select2.css')); ?>" />
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/ace-responsive.min.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(URL::asset('assets/css/ace-skins.min.css')); ?>" />

       <link href="<?php echo e(URL::asset('urlive-master/jquery.urlive.css')); ?>" rel="stylesheet" />
        <!--[if lte IE 8]>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var sesReply = "<?php echo e(Session::get('reply_id')); ?>";
