               ...
               <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="<?php echo e(url('/homeAdmin')); ?>">Home</a>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <div class="alert alert-block alert-success">
                                ...
                                hi <?php echo e(Auth::user()->real_name); ?> , Welcome to
                                <strong class="green">
                                    Dolpini
                                    <small>(v1.1.2)</small>
                                </strong>
                                ...
                                <div class="span12 infobox-container">
                                    <div class="infobox infobox-green  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo e(App\Models\Post::all()->count()); ?></span>
                                    ...
                                    <div class="infobox infobox-blue  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo e(App\Models\ReplyKubu::all()->count()); ?></span>
                                    ...
                                    <div class="infobox infobox-pink  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo e(App\Models\User::where('level','user')->count()); ?></span>
                                    ...
                                    <div class="infobox infobox-red  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo e(App\Models\Notif::all()->count()); ?></span>
                                                ...
                                                <div class="tab-content padding-8 overflow-visible">
                                                    ...
                                                    <div id="member-tab" class="tab-pane active">
                                                        <div class="clearfix">
                                                            ...
                                                            <?php echo $__env->make('admin.home_user', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                        ...
                                                        <div class="center">
                                                            ...
                                                            &nbsp;
                                                            <a href="<?php echo e(url('/user/admin')); ?>">
                                                                Lihat semua user &nbsp;
                                                    ...
                                                    <div id="topik-tab" class="tab-pane">
                                                        <div class="clearfix">
                                                            ...
                                                            <?php echo $__env->make('admin.home_topik', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                        ...
                                                        <div class="center">
                                                            ...
                                                            &nbsp;
                                                            <a href="<?php echo e(url('/post/admin')); ?>">
                                                                Lihat semua Topik &nbsp;
                                                                <i class="icon-arrow-right"></i>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div id="komentar-tab" class="tab-pane">
                                                        <div class="comments">
                                                            ...
                                                            <?php echo $__env->make('admin.home_komentar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                        ...
                                                        <div class="center">
                                                            ...
                                                            &nbsp;
                                                            <a href="<?php echo e(url('/post/reply/admin')); ?>">
